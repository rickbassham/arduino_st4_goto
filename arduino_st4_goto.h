...
/**
 * @brief The ArduinoST4GoTo class provides a simple mount simulator of an equatorial mount.
 *
 ...
 * @author Jasem Mutlaq
 */
class ArduinoST4GoTo : public INDI::Telescope, public INDI::GuiderInterface
{
public:
    ArduinoST4GoTo();
    virtual ~ArduinoST4GoTo() = default;
